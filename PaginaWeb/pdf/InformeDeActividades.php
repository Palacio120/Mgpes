      ...
      *{
      ...
      #img{
		...
		<?php
			...
			$consulta=$DB->CONSULTA("SELECT * from actividades join materias_cursadas on actividades.idActividades= materias_cursadas.idActividades join avances_trabajo on actividades.idActividades= avances_trabajo.idActividades   where actividades.idActividades='$id_actividades'");
		...
		<div class="Actividades" style="background-color: #DFDBDA; margin-top:-2px;" >
			...
			<table style="width: 100%; border-top: 1px solid;" cellspacing="0">
				<tr>
					...
					<td style="width: 50%;"><?php echo $rs['Materias'];  ?></td>
				</tr>
				<tr>
