   ...
   <page_header>
       ...
       *{
       ...
       #img{
		...
		<?php
			...
			$id_actividades=$_SESSION["Segundo_informe"];
    ...
    <div class="Actividades" style="background-color: #DFDBDA; margin-top:2px;" >
		...
		<?php
			...
			$DB=new ConfigDB;
			$conn=$DB->Mysql();
			$id_actividades=$_SESSION["Tercer_informe"];


			$SQL=$DB->CONSULTA("SELECT * From materias_semestres where Id_actividades = '$id_actividades';");
