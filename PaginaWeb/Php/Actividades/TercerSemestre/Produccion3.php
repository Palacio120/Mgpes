  ...
  <body>
      ...
      <?php
        ...
        $DB->Mysql();
          ...
          if(isset($_POST["Submit_Extracurriculares3"])){

            $verdad=isset($_GET["id_Extra3"]);
            if ($verdad && $verdad==1) {
              Include_once('../php/conf_tab.php');
              $DB= new ConfigDB();
              $DB->Mysql();

              $id_Extracurriculares1=$_GET["id_Extra3"];
          ...
          if (isset($_POST["Submit_Apoyo3"])) {

            $verdad=isset($_GET["id_apoyo3"]);
            if ($verdad && $verdad==1) {
              Include_once('../php/conf_tab.php');
              $DB= new ConfigDB();
              $DB->Mysql();
              $id_Apoyo=$_GET["id_apoyo3"];
          ...
          if (isset($_POST["Submit_Congreso3"])) {
            $verdad=isset($_GET["id_cong3"]);
            if ($verdad && $verdad==1) {
              Include_once('../php/conf_tab.php');
                        $DB= new ConfigDB();
                        $DB->Mysql();

                        $Id_congresos1=$_GET["id_cong3"];
                        $Nombre=$_POST["Nombre"];
                        $Titulo=$_POST["Titulo"];
          ...
          if (isset($_POST["Submit_Especializada3"])) {
            Include_once('../php/conf_tab.php');
                        $DB= new ConfigDB();
                        $DB->Mysql();

            $verdad=isset($_GET["id_Especial3"]);
            if ($verdad && $verdad==1) {

              $id_Especializada1=$_GET["id_Especial3"];
          ...
          if (isset($_POST["Submit_Asesorias3"])) {
            $verdad=isset($_GET["id_Tut3"]);
            if ($verdad && $verdad==1) {
              Include_once('../php/conf_tab.php');
                        $DB= new ConfigDB();
                        $DB->Mysql();

              $Id_Reporte_tutoria1=$_GET["id_Tut3"];
              $Fech_Reporte=$_POST["Fech_Reporte"];
              $Actividades=$_POST["Actividades"];
              $Tareas=$_POST["Tareas"];
              $Observaciones=$_POST["Observaciones"];
            ...
            if (isset($_POST["submitVinculacion3"])) {
                Include_once('../php/conf_tab.php');
                        $DB= new ConfigDB();
                        $DB->Mysql();

                $verdad=isset($_GET['id_vin3']);
                if ($verdad && $verdad==1) {

                        $Id_Vinculacion=$_GET['id_vin3'];
                        $Ambito=$_POST["Ambito"];
            ...
            if (isset($_POST["Submit_Movilidad3"])) {
                Include_once('../php/conf_tab.php');
                    $DB= new ConfigDB();
                    $DB->Mysql();

                  $verdad=isset($_GET['id_Mov3']);
                  if ($verdad && $verdad==1) {
        ...
        function ArticuloDifucion3(){?>
               <form name="form1" id="Alter301" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> id='Produccion1' method='post' enctype='multipart/form-data'>
                ...
                <div class="form-group">
                        ...
                        <input type='submit' value='Guardar' class='Botones' name="Submit301" >
        ...
        function articuloArbitrado3(){?>
           <form name="form2" id="Alter302" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> id='Movilidad1' method='post' enctype='multipart/form-data'>
             ...
             <div class="form-group">
                        ...
                        <div class="row" style="margin-bottom: 25px;">
                            ...
                            <input type='submit' name="Submit302" value='Guardar' class='Botones' >
                            <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
                </div>
            </form>

        <?php  }
        function RevistaIndexada3(){?>
            <form name="form3" id="Alter303" method="post" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_"  enctype='multipart/form-data'>
              ...
              <div class="form-group">
                ...
                <input type='submit' name="Submit303" value='Guardar' class='Botones' >
                <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
            </div>
            </form>

        <?php }
        function CapituloDeLibro3(){?>
            <form name="form4" id="Alter304" method="post" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_"  enctype='multipart/form-data'>
              ...
              <div class="form-group">
                ...
                <input type='submit' name="Submit304" value='Guardar' class='Botones' >
                <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
                </div>
            </form>

        <?php }
        function consultoria3(){ ?>
            <form name="forma5" id="Alter305" method="post" enctype="multipart/form-data" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_">
              <div class="row">
                <div class="col-md-8">
                    <h3>Consultoría</h3>
                </div>
              ...
              <div class="form-group">
                    <div class="row" style="margin-bottom: 25px;">
                      ...
                      <div class="row" style="margin-bottom: 25px;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                               <input type='submit' name="Submit305" value='Guardar' class='Botones' >
                               <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
                            </div>
                        </div>
        ...
        <?php }
        function InformeTecnico3(){?>
            <form name="forma6" id="Alter306" method="post" enctype="multipart/form-data" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_">
             <div class="row">
                <div class="col-md-8">
              ...
              <div class="form-group">
                ...
                <div class="row" style="margin-bottom: 25px;">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type='submit' name="Submit306" value='Guardar' class='Botones' >
                    <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
            </div>
            </form>
        ...
        <?php }
        function Libro3(){?>
            <form name="forma7" id="Alter307" method="post" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_"  enctype='multipart/form-data'>
                <div class="row">
                <div class="col-md-8">
                  <h3>libro</h3>
                </div>
              ...
              <div class="row" style="margin-bottom: 25px;";>
                  <div class="col-md-4">
                    ...
                    <input type='submit' name="Submit307" value='Guardar' class='Botones' >
                    <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
                </div>
            </form>

        <?php }
        function ManualesDeOperacion3(){?>
            <form name="forma8" id="Alter308" method="post" enctype="multipart/form-data" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>class="ns_">
            <div class="row">
                <div class="col-md-8">
                ...
                <div class="row" style="margin-bottom: 25px;">
                    ...
                    <input type='submit' name="Submit308" value='Guardar' class='Botones' >
                    <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
                </div>
            </form>

        <?php }
        function MaterialDeApoyo3(){?>
            <form name="forma9" id="Alter309" method="post" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_"  enctype='multipart/form-data'>
                <div class="row">
                    <div class="col-md-8">
                ...
                <div class="row" style="margin-bottom: 25px;">
                    ...
                    <input type='submit' name="Submit309" value='Guardar' class='Botones' >
                    <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
                </div>
            </form>
        ...
        <?php }
        function MaterialDidactico3(){?>
            <form name="forma10" id="Alter310" method="post" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_"  enctype='multipart/form-data'>
                <div class="row">
                    <div class="col-md-8">
                ...
                <input type='submit' name="Submit310" value='Guardar' class='Botones' >
                <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
            </div>
            </form>
        ...
        <?php }
        function Memorias3(){?>
          <form name="forma11" id="Alter311" method="post" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_"  enctype='multipart/form-data'>
            <div class="row">
                <div class="col-md-8">
                    <h3>memorias</h3>
                </div>
            ...
            <div class="row" style="margin-bottom: 25px;">
                ...
                <input type='submit' name="Submit311" value='Guardar' class='Botones' >
                <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
            </div>
          </form>

        <?php }
        function ProductividadInnovadora3(){?>
            <form name="forma12" id="Alter312" method="post" enctype="multipart/form-data" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_">
                <div class="row">
                    <div class="col-md-8">
                ...
                <div class="row" style="margin-bottom: 25px;">
                    <div class="col-md-4">
                      ...
                      <p style="display:none" id="ok7" class="letra">Este campo es obligatorio</p>
                        ...
                        <input type='submit' name="Submit312" value='Guardar' class='Botones' >
                        <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
              </div>
            </form>
        ...
        <?php }
        function ProduccionArtistica3(){?>

                <form name="forma13" id="Alter313" method="post" enctype="multipart/form-data" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_">
                    <div class="row">
                        <div class="col-md-8">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row" style="margin-bottom: 25px;">
                        ...
                        <input type='submit' name="Submit313" value='Guardar' class='Botones' >
                        <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
                  </div>
                </form>
        ...
        <?php }
        function Prototipo3(){?>
            <form name="forma14" id="Alter314" method="post" enctype="multipart/form-data" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_">
                <div class="row">
                    <div class="col-md-8">
                        <h3>Prototipo</h3>
                    </div>
              ...
              <div class="form-group">
                ...
                <div class="row" style="margin-bottom: 25px;">
                    ...
                    <input type='submit' name="Submit314" value='Guardar' class='Botones' >
                    <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
              </div>
            </form>
        ...
        <?php }
        function Otra3(){?>
            <form name="forma15" id="Alter315" method="post" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="ns_"  enctype='multipart/form-data'>
            <div class="row">
                <div class="col-md-8">
                    <h3>otra</h3>
                </div>
              ...
              <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <input type='submit' name="Submit315" value='Guardar' class='Botones' >
                    <input type='button' value='cancelar' onclick='cancelar_Actvidades()' class='Botones'>
            </div>
            </form>
            <?php } ?>
