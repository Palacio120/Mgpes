      ...
      <div id="center" style="marginLeft: 0px;">
        ...
        <div class="centro" id="centro" style="margin-left:0px;">
          <div id="Titulo" class="Titulo">
            ...
            <div id="Semestres" style="display: block;">
              <div class="Semestre">
                <a href="#" id="Segundo" onclick="desplegar_primero()" style="display:block; padding-bottom:10px"><p>Segundo Semetre</p></a>
              </div>
            </div>
            <div id="Semestres" style="display: block;">
              <div class="Semestre">
                <a href="#" id="Tercer" onclick="desplegar_primero()" style="display:block; padding-bottom:10px"><p>Tercer Semetre</p></a>
              </div>
            </div>
            <div id="Semestres" style="display: block;">
              <div class="Semestre">
                <a href="#" id="Cuarto" onclick="desplegar_primero()" style="display:block; padding-bottom:10px"><p>Cuarto Semetre</p></a>
              </div>
            </div>
          </div>
        </div>
