...
include_once('..\..\..\Php\CONACYT\DesempeñoAcademicoMixtaPHP.php');
          ...
          <div id="Titulo" class="Titulo">
            ...
            <div id="Semestres" style="display: block;">
              ...
              <div class="desplegar" style="display: none;" id="primer">
                ...
                $consulta=$DB->CONSULTA("SELECT * FROM mixtadesempeño WHERE semestre='Primer Semestre' and CODIGO_Es='$codigo'");
                ...
                <?php }else{ ?>
                  <table>
                    ...
                    <?php $consulta=$DB->CONSULTA("SELECT * FROM mixtadesempeño WHERE semestre='Primer Semestre' and CODIGO_Es='$codigo'");
                      while ($rs=$DB->Obtener_filas($consulta)) {
                     ?>
                    <tr>
                      ...
                      <td><?php if (!is_null($rs["InformeActividades"])) {echo "SI";}else {echo "NO";} ?></td>
                    </tr>
                  <?php } ?>
                  </table>
                ...
                <div class="FormatoSemestre" id="1" style="display:none;">
                  <form action="<?Php htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post" enctype="multipart/form-data">
                      <table>
                        ...
                        <tr>
                          <td>Formato de Informe de Actividades realizadas debidamente el coordinador académico del posgrado, el tutor, el cotutor y el becario.</td>
                          <td>
            ...
            <div id="Semestres" style="display: block;">
              ...
              <div class="desplegar" style="display: none;" id="Segund">
                <div id="tabla2" style="display:block;">
                  ...
                  $consulta=$DB->CONSULTA("SELECT * FROM mixtadesempeño WHERE semestre='Segundo Semestre' and CODIGO_Es='$codigo'");
                  while ($rs= $DB->Obtener_filas($consulta)) {
                    $bandera=false;
                  }
                  if ($bandera){ ?>
                  ...
                  <?php }else{ ?>
                    <table>
                      ...
                      <?php $consulta=$DB->CONSULTA("SELECT * FROM mixtadesempeño WHERE semestre='Segundo Semestre' and CODIGO_Es='$codigo'");
                        while ($rs=$DB->Obtener_filas($consulta)) {
                       ?>
                      <tr>
                        <td>Formato de evaluación del desempeño del becario (resguardo tanto en físico como electrónico), debidamente firmado por el asesor y coordinador académico del posgrado.</td>
            ...
            <div id="Semestres"  style="display: block;">
              ...
              <div class="desplegar" style="display: none;" id="Tercer">
                <div id="tabla3" style="display:block">
                  ...
                  $consulta=$DB->CONSULTA("SELECT * FROM mixtadesempeño WHERE semestre='Tercer Semestre' and CODIGO_Es='$codigo'");
                  while ($rs= $DB->Obtener_filas($consulta)) {
                    $bandera=false;
                  }
                  if ($bandera){ ?>
                  ...
                  <?php }else{ ?>
                    <table>
                      ...
                      <?php $consulta=$DB->CONSULTA("SELECT * FROM mixtadesempeño WHERE semestre='Tercer Semestre' and CODIGO_Es='$codigo'");
                        while ($rs=$DB->Obtener_filas($consulta)) {
                       ?>
                      <tr>
                        <td>Formato de evaluación del desempeño del becario (resguardo tanto en físico como electrónico), debidamente firmado por el asesor y coordinador académico del posgrado.</td>
            ...
            <div id="Semestres" style="display: block;">
              ...
              <div class="desplegar" style="display: none;" id="Cuar">
                <div id="tabla4" style="display:block">
                  ...
                  $consulta=$DB->CONSULTA("SELECT * FROM mixtadesempeño WHERE semestre='Cuarto Semestre' and CODIGO_Es='$codigo'");
                  while ($rs= $DB->Obtener_filas($consulta)) {
                    $bandera=false;
                  }
                  if ($bandera){ ?>
                  ...
                  <?php }else{ ?>
                    <table>
                      ...
                      <?php $consulta=$DB->CONSULTA("SELECT * FROM mixtadesempeño WHERE semestre='Cuarto Semestre' and CODIGO_Es='$codigo'");
                        while ($rs=$DB->Obtener_filas($consulta)) {
                       ?>
                      <tr>
                        <td>Formato de evaluación del desempeño del becario (resguardo tanto en físico como electrónico), debidamente firmado por el asesor y coordinador académico del posgrado.</td>
