      ...
      <div id="center" style="margin-Left: 0px;">
        ...
        <div  id="centro" style="marginLeft:0px;">
          <div class="menu_centrado">
            <div class="cuadro"><a href="BecaMixta\Asignacion.php"><p>Asignación de beca Mixta</p></a></div>
            <div class="cuadro"><a href="BecaMixta\DesempenoAcademico.php"><p>Desempeño academico de beca Mixta</p></a></div>
          </div>
