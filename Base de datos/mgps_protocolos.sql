...
CREATE TABLE `protocolos` (
  ...
  `DescripccionProtocolo` longtext,
  `EstadoProtocolo` enum('Aceptedo','Rechazado') DEFAULT NULL,
  PRIMARY KEY (`Codigo_es`),
  CONSTRAINT `protocolos_ibfk_1` FOREIGN KEY (`Codigo_es`) REFERENCES `estudiante` (`CODIGO_ES`) ON UPDATE CASCADE
...
=======
-- Dump completed on 2018-03-08  9:05:45
